...
public class ActionMenu : IMenu
{
	...
	private static Rectangle refineButton = GameUtil.Button(30, 130);
	private static Rectangle gatherButton = GameUtil.Button(30, 210);
	...
	public void Draw()
	{
		...
		// Refine button
		if (RayGui.GuiButton(refineButton, "Refine") && GameData.GameAges[GameData.Age].CanPerform())
		...
		// Forge button
		if (RayGui.GuiButton(forgeButton, "Forge"))
			forgingProduct = true;
